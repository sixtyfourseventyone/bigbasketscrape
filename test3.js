...
for(var i=0; i<links.length; i++){
    productLinks[i]=links[i];
    console.log(productLinks[i]);
}

page.open('https://www.bigbasket.com/'+productLinks[0], function(status) {
...
//     console.log('connecting to https://www.bigbasket.com/'+value);

//     page.open('https://www.bigbasket.com/'+value, function(status) {
//     console.log("Status: " + status);
//     if(status === "success") {
//       //page.render('bb.png');
